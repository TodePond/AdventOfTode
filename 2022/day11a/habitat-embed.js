...
//========//
{
  ...
  //====== ./colour.js ======
  {
    ...
    const Colour = class extends Array {
      ...
      toString() {
        const [red, green, blue, alpha] = this.map((v) =>
    ...
    HabitatFrogasaurus["./colour.js"].registerColourMethods =
  ...
  //====== ./console.js ======
  {
    ...
    HabitatFrogasaurus["./console.js"].registerDebugMethods =
  ...
  //====== ./keyboard.js ======
  {
    ...
    const keyDown = (key) => {
      if (!isKeyDownTracked) {
        ...
        on("keydown", (e) => fireEvent(`keyDown("${e.key}")`), {
          passive: false,
        });
      }
      return `keyDown("${key}")`;
  ...
  //====== ./mouse.js ======
  {
    ...
    const mouseDown = (buttonName) => {
      ...
      if (!isMouseDownTracked) {
        ...
        on("mousedown", (e) => fireEvent(`mouseDown("${e.button}")`), {
          passive: false,
        });
      }
    ...
    const mouseUp = (buttonName) => {
      ...
      if (!isMouseUpTracked) {
        ...
        on("mouseup", (e) => fireEvent(`mouseUp("${e.button}")`), {
          passive: false,
        });
      }
  ...
  //====== ./vector.js ======
  {
    ...
    HabitatFrogasaurus["./vector.js"].registerVectorMethods =
      registerVectorMethods;
  }
  ...
  const { registerVectorMethods, add, crossProduct, scale, subtract } =
    HabitatFrogasaurus["./vector.js"];
